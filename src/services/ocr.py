...
class OCRService(ABC):
    ...
    def process_image(self, image_path: str) -> TransactionModel:
            ...
            input=[
                {
                    ...
                    "content": [
                        {"type": "input_text", "text":
                         "Analyze this Polish fiscal receipt. Extract: 1. Vendor name 2. Title (PARAGON FISKALNY) 3. Product list (name, quantity, price, unit_price) 4. Total amount 5. Transaction date. Return only valid data; omit missing fields."},
                        {
                            "type": "input_image",
