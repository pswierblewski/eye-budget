...
class OCRService(ABC):
    def __init__(self, client: OpenAI | None = None, async_client: AsyncOpenAI | None = None):
        ...
        self.prompt = (
            ...
            "   Each line on the receipt is a separate product entry — "
            "   never group or merge identical lines even if the name and price are the same. "
            "   Make sure that the identical lines you extracted have the same amount of products as the original receipt."
